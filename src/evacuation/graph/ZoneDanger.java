...
public class ZoneDanger extends Node {
    ...
    public ZoneDanger(String id, String nom, String typeDanger, int niveauRisque){
        super(id, nom); this.typeDanger = typeDanger; this.niveauRisque = niveauRisque; bloquer();
    }

    public ZoneDanger(String id, String nom, int x, int y, String typeDanger, int niveauRisque){
        super(id, nom, x, y); this.typeDanger = typeDanger; this.niveauRisque = niveauRisque; bloquer();
    }
    ...
    public String getTypeDanger(){ return typeDanger; }
